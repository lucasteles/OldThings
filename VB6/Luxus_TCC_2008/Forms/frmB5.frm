...
If forn = True Then
frmContasPagar.mskCod_Forn.PromptInclude = False
frmContasPagar.mskCod_Forn = flexClientes.TextMatrix(flexClientes.Row, 0)
frmContasPagar.cmdBusc_Cod = True
frmContasPagar.mskCod_Forn.PromptInclude = True
Call Cap
Else
frmPeças.mskCodfor.PromptInclude = False
frmPeças.mskCodfor = flexClientes.TextMatrix(flexClientes.Row, 0)
frmPeças.mskCodfor.PromptInclude = True
frmPeças.Command1 = True
Call Peças
End If
Unload Me
End Sub
...
If forn = True Then
frmContasPagar.Enabled = True
forn = False
Else
frmPeças.Enabled = True
End If
End Sub
