...
Begin VB.Form frmForneced 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox txtUF 
         Height          =   315
         ItemData        =   "frmForne.frx":3D7C
         Left            =   6720
         List            =   "frmForne.frx":3DD1
         TabIndex        =   25
         Text            =   "UF"
         Top             =   3240
         Width           =   855
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   5520
         OleObjectBlob   =   "frmForne.frx":4F49
         TabIndex        =   31
         Top             =   3000
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   6720
         OleObjectBlob   =   "frmForne.frx":4FAD
         TabIndex        =   32
         Top             =   3000
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   6600
         OleObjectBlob   =   "frmForne.frx":5013
         TabIndex        =   33
         Top             =   2160
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   3240
         OleObjectBlob   =   "frmForne.frx":5081
         TabIndex        =   34
         Top             =   3000
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   255
         Left            =   240
         OleObjectBlob   =   "frmForne.frx":50EB
         TabIndex        =   35
         Top             =   1320
         Width           =   2655
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel11 
         Height          =   255
         Left            =   2400
         OleObjectBlob   =   "frmForne.frx":5161
         TabIndex        =   36
         Top             =   480
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   255
         Left            =   240
         OleObjectBlob   =   "frmForne.frx":51C7
         TabIndex        =   37
         Top             =   3000
         Width           =   1455
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   5400
         OleObjectBlob   =   "frmForne.frx":5231
         TabIndex        =   39
         Top             =   2160
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   375
         Left            =   240
         OleObjectBlob   =   "frmForne.frx":529B
         TabIndex        =   40
         Top             =   480
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   240
         OleObjectBlob   =   "frmForne.frx":5305
         TabIndex        =   41
         Top             =   2160
         Width           =   2655
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel9 
         Height          =   255
         Left            =   4680
         OleObjectBlob   =   "frmForne.frx":5377
         TabIndex        =   52
         Top             =   1320
         Width           =   2655
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.ComboBox cmbBusca 
            Height          =   315
            ItemData        =   "frmForne.frx":53EF
            Left            =   240
            List            =   "frmForne.frx":53FC
            TabIndex        =   8
            Text            =   "R. Social"
            Top             =   360
            Width           =   1455
   ...
   Begin VB.Frame Frame5 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel lbl1 
         Height          =   375
         Left            =   1800
         OleObjectBlob   =   "frmForne.frx":541B
         TabIndex        =   1
         Top             =   120
         Visible         =   0   'False
         Width           =   375
      ...
      Begin ACTIVESKINLibCtl.SkinLabel lbl 
         Height          =   375
         Left            =   5280
         OleObjectBlob   =   "frmForne.frx":547D
         TabIndex        =   2
         Top             =   120
         Width           =   2055
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel12 
         Height          =   375
         Left            =   480
         OleObjectBlob   =   "frmForne.frx":54F3
         TabIndex        =   3
         Top             =   120
         Width           =   1455
      End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel14 
      Height          =   255
      Left            =   120
      OleObjectBlob   =   "frmForne.frx":5561
      TabIndex        =   6
      Top             =   1920
      Width           =   735
   End
End
Attribute VB_Name = "frmForneced"
...
Private Sub Command2_Click()
            ...
            Else
            tabelas.Close
            tabelas.Open "select * from fornecedores where CNPJ= '" & mskCNPJ & "'"
...
Private Sub cmdAnt_Click()
            ...
            Call mostrar
            Else
            MsgBox "NAO A FORNECEDORES CADASTRADOS", vbExclamation
            End If
            End If
            End If
            Call ativar
...
Call Tirar
            ...
            Else
            tabelas.Close
            tabelas.Open "select * from fornecedores  where codigo=" & mskCod
            If tabelas.BOF = False Or tabelas.EOF = False Then
            Call mostrar
            End If
            End If
...
Call Tirar
           ...
           Else
           On Error GoTo d
           conecta.Execute "delete * from fornecedores where codigo=" & mskCod
           cmdNovo = True
           status = "excluidos"
           Call crash1
           navegaçao = Clear
         ...
         Exit Sub
d:
MsgBox "Este fornecedor não pode ser excluido pois ja possui um historico", vbExclamation
End Sub
...
Call Tirar
     ...
     'codigo autometico
        ...
        tabelas.Close
        tabelas.Open "select * from fornecedores where codigo=" & a
        If tabelas.BOF = False Or tabelas.EOF = False Then
        a = a + 1
        Else
        b = 1
...
Call Tirar
            ...
            Else
            tabelas.Close
            tabelas.Open "select * from fornecedores where razaosocial like '" & txtRsocial & "%'"
            If tabelas.BOF = False Or tabelas.EOF = False Then
            Call mostrar
