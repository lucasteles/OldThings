...
Begin VB.Form frmTransport 
   ...
   Begin VB.PictureBox SSTab1 
      ...
      Begin VB.PictureBox pctExcluir 
         ...
         Height          =   495
         Left            =   240
         Picture         =   "frmTransportadora.frx":0000
         ScaleHeight     =   495
         ScaleWidth      =   375
         TabIndex        =   49
         Top             =   120
      ...
      Begin VB.PictureBox pctSalvar 
         ...
         Height          =   495
         Left            =   120
         Picture         =   "frmTransportadora.frx":0CCA
         ScaleHeight     =   495
         ScaleWidth      =   615
         TabIndex        =   48
         Top             =   120
      ...
      Begin VB.PictureBox pctNovo 
         ...
         Height          =   495
         Left            =   120
         Picture         =   "frmTransportadora.frx":1594
         ScaleHeight     =   495
         ScaleWidth      =   495
         TabIndex        =   47
         Top             =   120
      ...
      Begin VB.PictureBox pctBuscar 
         ...
         Height          =   495
         Left            =   120
         Picture         =   "frmTransportadora.frx":225E
         ScaleHeight     =   495
         ScaleWidth      =   495
         TabIndex        =   46
         Top             =   120
      ...
      Begin VB.PictureBox pctluxus 
         ...
         Height          =   375
         Left            =   120
         Picture         =   "frmTransportadora.frx":2F28
         ScaleHeight     =   375
         ScaleWidth      =   495
         TabIndex        =   45
         Top             =   120
      ...
      Begin VB.PictureBox pctNav 
         ...
         Height          =   375
         Left            =   240
         Picture         =   "frmTransportadora.frx":37F2
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   44
         Top             =   120
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton cmdUlt 
            ...
            Height          =   375
            Left            =   1680
            Picture         =   "frmTransportadora.frx":3D7C
            TabIndex        =   27
            Top             =   240
            Width           =   615
         End
         Begin VB.CommandButton cmdAnt 
            ...
            Height          =   375
            Left            =   720
            Picture         =   "frmTransportadora.frx":41BE
            TabIndex        =   26
            Top             =   240
            Width           =   495
         End
         Begin VB.CommandButton cmdProx 
            ...
            Height          =   375
            Left            =   1200
            Picture         =   "frmTransportadora.frx":4600
            TabIndex        =   25
            Top             =   240
            Width           =   495
         End
         Begin VB.CommandButton cmdPrim 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmTransportadora.frx":4A42
            TabIndex        =   24
            Top             =   240
            Width           =   615
         End
      ...
      Begin VB.ComboBox txtUF 
         Height          =   315
         ItemData        =   "frmTransportadora.frx":4E84
         Left            =   6720
         List            =   "frmTransportadora.frx":4ED9
         TabIndex        =   14
         Text            =   "UF"
         Top             =   3240
         Width           =   855
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   5400
         OleObjectBlob   =   "frmTransportadora.frx":4F49
         TabIndex        =   31
         Top             =   2880
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   6600
         OleObjectBlob   =   "frmTransportadora.frx":4FAD
         TabIndex        =   32
         Top             =   2880
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   6480
         OleObjectBlob   =   "frmTransportadora.frx":5013
         TabIndex        =   33
         Top             =   2040
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   3120
         OleObjectBlob   =   "frmTransportadora.frx":5081
         TabIndex        =   34
         Top             =   2880
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmTransportadora.frx":50EB
         TabIndex        =   35
         Top             =   1200
         Width           =   2655
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel11 
         Height          =   255
         Left            =   2400
         OleObjectBlob   =   "frmTransportadora.frx":5161
         TabIndex        =   36
         Top             =   360
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmTransportadora.frx":51C7
         TabIndex        =   37
         Top             =   2880
         Width           =   1455
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   5280
         OleObjectBlob   =   "frmTransportadora.frx":5231
         TabIndex        =   39
         Top             =   2040
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   375
         Left            =   240
         OleObjectBlob   =   "frmTransportadora.frx":529B
         TabIndex        =   40
         Top             =   360
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "frmTransportadora.frx":5305
         TabIndex        =   41
         Top             =   2040
         Width           =   2655
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel9 
         Height          =   255
         Left            =   5040
         OleObjectBlob   =   "frmTransportadora.frx":5377
         TabIndex        =   53
         Top             =   1320
         Width           =   2655
      End
   ...
   Begin VB.Frame Frame5 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel lbl1 
         Height          =   375
         Left            =   1800
         OleObjectBlob   =   "frmTransportadora.frx":53EF
         TabIndex        =   4
         Top             =   120
         Visible         =   0   'False
         Width           =   375
      ...
      Begin ACTIVESKINLibCtl.SkinLabel lbl 
         Height          =   375
         Left            =   5280
         OleObjectBlob   =   "frmTransportadora.frx":5451
         TabIndex        =   5
         Top             =   120
         Width           =   2535
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel12 
         Height          =   375
         Left            =   480
         OleObjectBlob   =   "frmTransportadora.frx":54CD
         TabIndex        =   6
         Top             =   120
         Width           =   1455
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.ComboBox cmbBusca 
            Height          =   315
            ItemData        =   "frmTransportadora.frx":553B
            Left            =   240
            List            =   "frmTransportadora.frx":5548
            TabIndex        =   8
            Text            =   "R. Social"
            Top             =   360
            Width           =   1455
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel14 
      Height          =   255
      Left            =   120
      OleObjectBlob   =   "frmTransportadora.frx":5567
      TabIndex        =   2
      Top             =   1920
      Width           =   735
   End
...
Private Sub cmdAnt_Click()
            ...
            Call mostrar
            Else
            MsgBox "NAO A TRANSPORTADORAS CADASTRADOS", vbExclamation
            End If
            End If
            End If
            Call ativar
...
Private Sub cmdBuscCod_Click()
            ...
            Else
            tabelas.Close
            tabelas.Open "select * from TRANSPORTADORA  where codigo=" & mskCod
...
Private Sub cmdExclu_Click()
           ...
           Else
           On Error GoTo d
           conecta.Execute "delete * from TRANSPORTADORA where codigo=" & mskCod
           cmdNovo = True
           status = "excluidos"
           Call crash1
           navegaçao = Clear
...
Private Sub cmdProx_Click()
            ...
            Call mostrar
            Else
            MsgBox "NAO A TRANSPORTADORA CADASTRADOS", vbExclamation
            End If
            Call ativar
            End If
            End If
...
Private Sub cmdSalvar_Click()
     ...
     'codigo autometico
        ...
        tabelas.Close
        tabelas.Open "select * from transportadora where codigo=" & a
        If tabelas.BOF = False Or tabelas.EOF = False Then
        a = a + 1
        Else
        b = 1
...
Private Sub cmdBuscNome_Click()
            ...
            Else
            tabelas.Close
            tabelas.Open "select * from TRANSPORTADORA where razaosocial like '" & txtRsocial & "%'"
            If tabelas.BOF = False Or tabelas.EOF = False Then
            Call mostrar
            End If
            End If
...
Private Sub Command2_Click()
            ...
            Else
            tabelas.Close
            tabelas.Open "select * from transportadoras where CNPJ= '" & mskCNPJ & "'"
            If tabelas.BOF = False Or tabelas.EOF = False Then
            Call mostrar
            Else
...
Private Sub mostrar()
             ...
             txtNomeF = IIf(IsNull(tabelas!nomeF), "", tabelas!nomeF)
...
Private Sub txtbuscas_Change()
            ...
            tabelas.Close
            tabelas.Open "select * from TRANSPORTADORA where razaosocial like '" & txtbuscas & "%' order by codigo"
            Call carregar_lista
            ElseIf cmbBusca = "Telefone" Then
             tabelas.Close
             tabelas.Open "select * from TRANSPORTADORA  where telefone like '" & txtbuscas & "%' order by codigo"
            Call carregar_lista
            ElseIf cmbBusca = "CNPJ" Then
            tabelas.Close
             tabelas.Open "select * from TRANSPORTADORA  where cnpj like '" & txtbuscas & "%' order by codigo"
            End If
