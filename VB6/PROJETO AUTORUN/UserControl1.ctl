...
Begin VB.UserControl TelesBar 
   ...
   Begin VB.Label Label1 
      ...
      Height          =   540
      Left            =   1680
      MouseIcon       =   "UserControl1.ctx":030A
   ...
   Begin VB.Image Image1 
      Height          =   615
      Left            =   480
      MouseIcon       =   "UserControl1.ctx":0614
      MousePointer    =   99  'Custom
      Stretch         =   -1  'True
      Top             =   480
      Width           =   735
   ...
   Begin VB.Image picture1 
      Height          =   1575
      Left            =   0
      MouseIcon       =   "UserControl1.ctx":091E
      MousePointer    =   99  'Custom
      Picture         =   "UserControl1.ctx":0C28
      Stretch         =   -1  'True
      Top             =   0
      Width           =   5475
   End
End
Attribute VB_Name = "TelesBar"
...
Private Sub Tconf_Timer()
    Dim Ponter As POINTAPI

    GetCursorPos Ponter
    ScreenToClient hwnd, Ponter

    If Ponter.x < Picture1.Left Or Ponter.y < Picture1.Top Or _
       Ponter.x > (Picture1.Width / 100) * 6.63 Or _
       Ponter.y > (Picture1.Height / 100) * 6.63 _
    Then
        ONobject = False
        Call Back
        Tconf.Enabled = False
...
Private Sub UserControl_Show()
    Image1.Width = image_w
    Image1.Height = image_h
End Sub
...
ImagemLargura = image_w 'Image1.Width
End Property
...
ImagemAltura = image_h 'Image1.Height
End Property
